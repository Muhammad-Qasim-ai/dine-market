    ...
    <>
      <div className="flex gap-8">
        ...
        <div className="flex items-center ">
          ...
          <AiOutlinePlus
            ...
            className="ml-[10px] cursor-pointer bg-[#f1f1f1] rounded-[50%] p-1 w-[30px] h-[30px] border-2 border-black"
          />
        </div>
      </div>
      <div className="flex items-center gap-4">
        <button
          ...
          className="w-[40%] p-3 text-base font-semibold bg-startbg flex items-center justify-center gap-2 text-startcol tracking-wider"
        >
          <LuShoppingCart className="text-2xl" />
          Add to Cart
        </button>
        <p className="  font-[700] text-[1.5rem] leading-[30px] tracking-[0.1em]">
          ${item.price}.00
        </p>
      </div>
    </>
