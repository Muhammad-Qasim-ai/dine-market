        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-[2fr,1fr,1fr,1fr] px-[2rem] md:px-[4rem] md:py-[8rem]">
                <div className="flex flex-col justify-between w-[80%] md:gap-y-0 gap-y-10" >
                    ...
                    <p className="font-[400] text-[1rem] leading-[22px] text-[#666]">Small, artisan label that offers a thoughtfully curated collection of high quality everyday essentials made.</p>
                ...
                <div className='md:my-0 my-10'>
                    <h3 className='font-[700] text-[1.2rem] leading-[19px] tracking-[0.02em] text-[#666]'>Company</h3>
                ...
                <div className='md:my-0 my-10'>
                    <h3 className='font-[700] text-[1.2rem] leading-[19px] tracking-[0.02em] text-[#666]'>Support</h3>
                    <ul className='font-[400] text-base leading-[22px] text-[#666]   '>
                ...
                <div className='md:my-0 my-10'>
                    <h3 className='font-[700] text-[1.2rem] leading-[19px] tracking-[0.02em] text-[#666]'>Contact</h3>
                    <ul className='font-[400] text-base leading-[22px] text-[#666]   '>
