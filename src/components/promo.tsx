  ...
  return (
    <>
      <div className="3xl:pl-[20rem] flex flex-col xl:mx-28 lg:mx-2 3md:mx-7 mx-3   my-16 ">
        ...
        <h2 className=" tracking-wider text-center text-3xl font-extrabold ">
          Our Promotion Events
        </h2>
        <div
          className=" mt-10 overflow-hidden lg:max-h-434 gap-8 flex lg:flex-row flex-col
                 w-full "
        >
          <div className=" gap-4 flex flex-col lg:w-63.5 ">
            ...
            <div className=" h-52 w-full flex justify-center flex-col bg-promobg2 text-startcol items-center">
              <h1 className="text-3xl mb-3 font-extrabold tracking-wide">
                GET 30% Off
              </h1>
              <h2 className="text-sm">USE PROMO CODE</h2>
              <div className="w-80 p-1 font-bold text-center rounded-md   bg-red-600 tracking-widiest mt-1">
                DINEWEEKENDSALE
              </div>
            </div>
          </div>
